...
<head>
    ...
    <title>Sign In - Ride Revive</title>
    ...
    <style>
        * {
        ...
        .shape:nth-child(4) { width: 50px; height: 50px; top: 30%; left: 70%; animation-delay: 6s; }
    ...
    <div class="main-container">
        ...
        <div class="form-panel">
            ...
            <div id="login-section" class="form-section active">
                ...
                <form action="authenticate.php" method="POST" onsubmit="return handleSubmit(this)">
                    ...
                    <div class="form-group">
                        <div class="input-container">
                            <input type="password" class="form-input" name="password" placeholder="Enter your password" required minlength="6">
                ...
                <!-- Google Sign-In Button -->
                <a href="https://accounts.google.com/o/oauth2/auth?client_id=551906749283-ve45j56noq4bm7r14gda9ustc7kaqla1.apps.googleusercontent.com&redirect_uri=http://127.0.0.1/car-detailing/auth/google-callback.php&scope=email%20profile&response_type=code&access_type=offline" class="btn-google">
                ...
                <div class="form-links">
                    <p style="color: #ccc; margin-bottom: 15px;">
                        <a href="#" class="form-link" onclick="showResetForm()">Forgot your password?</a>
                    </p>
                    <p style="color: #ccc;">
            ...
            <div id="reset-section" class="form-section">
                <a href="#" class="back-btn" onclick="showLoginForm()">
